...
public class AdminController {
	...
	public LibraryManagementSystemResponse addBook(@PathVariable("userId") int userId, @RequestBody BookInfo bookInfo) {
	...
	public LibraryManagementSystemResponse acceptRequest(@PathVariable("userId") int registerId) {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		HttpEntity<String> entity = new HttpEntity<String>(headers);
		return restTemplate.exchange("http://localhost:8082/acceptRequest/" + registerId, HttpMethod.GET, entity,
				LibraryManagementSystemResponse.class).getBody();
	}
	...
	public LibraryManagementSystemResponse requestView() {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		HttpEntity<String> entity = new HttpEntity<String>(headers);
		return restTemplate.exchange("http://localhost:8082/requestView", HttpMethod.GET, entity,
				LibraryManagementSystemResponse.class).getBody();
	}
